package com.xc.xcpulltoloadmorelistview;
...
public class XCPullToLoadMoreListView extends FrameLayout {
    ...
    public XCPullToLoadMoreListView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XCPullToLoadMoreListView(Context context, AttributeSet attrs, int defStyleAttr) {
